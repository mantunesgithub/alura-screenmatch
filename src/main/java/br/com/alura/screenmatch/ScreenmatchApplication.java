...
public class ScreenmatchApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        json = consumoApi.obterDados("https://www.omdbapi.com/?t=Gilmore+girls&season=1&episode=2&apikey=ecba5782");
        ...
        for (int i = 1; i <= dados.totalTemporadas(); i++) {
            ...
            json = consumoApi.obterDados("https://www.omdbapi.com/?t=Gilmore+girls&season=" + i + "&apikey=ecba5782");
